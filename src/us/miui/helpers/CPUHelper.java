...
//			DataInputStream in = new DataInputStream(fstream);
//			BufferedReader br = new BufferedReader(new InputStreamReader(in));
			line = RootUtils.executeWithResult("cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq\n");
//			in.close();
		} catch (IOException e) {
...
//			DataInputStream in = new DataInputStream(fstream);
//			BufferedReader br = new BufferedReader(new InputStreamReader(in));
			line = RootUtils.executeWithResult("cat /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq\n");
//			in.close();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
