...
public class PieMenu extends FrameLayout {
    ...
    private void init(Context ctx) {
        ...
        mRadius = (int) res.getDimension(R.dimen.fannav_radius_start);
        mRadiusInc = (int) res.getDimension(R.dimen.fannav_radius_increment);
        mSlop = (int) res.getDimension(R.dimen.fannav_slop);
        mTouchOffset = (int) res.getDimension(R.dimen.fannav_touch_offset);
        mOpen = false;
        ...
        if (MotionEvent.ACTION_DOWN == action) {
            ...
            if (item == null) {
                ...
                if ((item != null) && item.isPieView() && (item.getView() != null)) {
                    int cx = item.getView().getLeft() + (onTheTop()
    ...
    private void layoutPieView(PieView pv, int x, int y, float angle) {
        pv.layout(x, y, onTheTop(), angle, getHeight());
    }
